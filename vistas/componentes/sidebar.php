    ...
    <div id="mySidenav" class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="\gestion_consultas_php\img\LOGO.png" class="navbar-brand-img" alt="...">
        </a>
      </div>
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" href="/gestion_consultas_php/vistas/dashboard.php">
                <span class="nav-link-text">Menú principal</span>
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/gestion_consultas_php/vistas/listado_consultas.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/gestion_consultas_php/upload-excel/uploadexc.php">
